...
**現在のリリース: [v2.3.1](https://github.com/Xenoah/stackchan-mqtt/releases/tag/v2.3.1)（プレリリース）**
...
```powershell
python -m esptool --chip esp32s3 --port COM4 --baud 921600 write_flash 0x0 stackchan-mqtt-v2.3.1-full.bin
```
